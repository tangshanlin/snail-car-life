...
//        gc.setOutputDir(projectPath+"/car-auth-server/car-auth-web/src/main/java");
        gc.setOutputDir("F:\\javaFile\\snail-car-life\\car-items-server\\car-items-web\\src\\main\\java");
        ...
        dsc.setUrl("jdbc:mysql://119.23.75.195/car-items-server?characterEncoding=utf-8");
        ...
        pc.setParent("com.woniu.car.items.web");                            //设置模块中的父目录名
        ...
        // 设置要生成的实体类对应映射的表名
        strategy.setInclude("t_car_service","t_car_service_flowpath","t_one_classify","t_two_classify","t_user_car_service");
