...
public class MybatisPlusAutoCode {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath+"/car-message-server/car-message-web/src/main/java");
        gc.setAuthor("ZYY");                            //设置项目作者
        ...
        dsc.setUrl("jdbc:mysql://119.23.75.195:3306/message?characterEncoding=utf-8");
        ...
        pc.setParent("com.woniu.car.message.web");                            //设置模块中的父目录名
        ...
        // 设置要生成的实体类对应映射的表名
        strategy.setInclude("t_producer_message","t_comsumer_message");
