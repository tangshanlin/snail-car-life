...
public class MybatisPlusAutoCode {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath+"/car-product-server/car-product-web/src/main/java");         //自定义代码生成后的存放目录
        gc.setAuthor("cx");                            //设置项目作者
        ...
        dsc.setUrl("jdbc:mysql://119.23.75.195:3306/car-product-server?characterEncoding=utf-8");
        ...
        pc.setParent("com.woniu.car.product.web");                            //设置模块中的父目录名
        ...
        // 设置要生成的实体类对应映射的表名
        strategy.setInclude("t_product","t_product_cate","t_product_info");
