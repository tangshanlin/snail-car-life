package com.woniu.car.station.web.util;
...
//        gc.setOutputDir(projectPath+"/car-auth-server/car-auth-web/src/main/java");
        gc.setOutputDir("F:\\javaFile\\snail-car-life\\car-station-server\\car-station-web\\src\\main\\java");
        gc.setAuthor("Sokyo");                            //设置项目作者
        gc.setOpen(false);                                     //代码生成后是否打开文件夹
        gc.setFileOverride(false);                             //是否覆盖
        gc.setServiceName("%sService");                        //去Service的I前缀
        gc.setIdType(IdType.AUTO);                        //自定义主键生成策略
        ...
        dsc.setUrl("jdbc:mysql://119.23.75.195/car-station-server?characterEncoding=utf-8");
        ...
        pc.setParent("com.woniu.car.station.web");                            //设置模块中的父目录名
        ...
        // 设置要生成的实体类对应映射的表名
        strategy.setInclude("t_powerplant","t_powerplant_applyfor","t_station");
