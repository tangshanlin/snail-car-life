...
public class MybatisPlusAutoCode {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath+"/car-user-server/car-user-web/src/main/java/");
        gc.setAuthor("sushanhu");                            //设置项目作者
        ...
        dsc.setUrl("jdbc:mysql://119.23.75.195/car-user-server?characterEncoding=utf-8");
        ...
        pc.setParent("com.woniu.car.user.web");                            //设置模块中的父目录名
        ...
        // 设置要生成的实体类对应映射的表名
        strategy.setInclude("t_driving_license");
