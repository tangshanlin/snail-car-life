...
public class MybatisPlusAutoCode {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath+"\\car-shop-server\\car-shop-web\\src\\main\\java");         //自定义代码生成后的存放目录
        ...
        dsc.setUrl("jdbc:mysql://119.23.75.195:3306/car-shop-server?useUnicode=true&useSSL=false&characterEncoding=utf-8");
...
//        pc.setModuleName("rbac");                             //指定生成的模块名称
        pc.setParent("com.woniu.car.shop");                            //设置模块中的父目录名
...
//        strategy.setInclude("t_user","city","county","countrylanguage");
        strategy.setInclude("t_shop","t_shop_earnings_info","t_shop_service_earnings");
