...
public class MybatisPlusAutoCode {
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://119.23.75.195/car-auth-server?characterEncoding=utf-8");
        ...
        pc.setParent("com.woniu.car.auth.web");                            //设置模块中的父目录名
        ...
        // 设置要生成的实体类对应映射的表名
        strategy.setInclude("t_back_balance");
