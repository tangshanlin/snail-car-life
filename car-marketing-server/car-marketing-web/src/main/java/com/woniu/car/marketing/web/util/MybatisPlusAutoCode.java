package com.woniu.car.marketing.web.util;
...
public class MybatisPlusAutoCode {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath+"/car-marketing-server/car-marketing-web/src/main/java");         //自定义代码生成后的存放目录
        gc.setAuthor("tsl");                            //设置项目作者
        ...
        dsc.setUrl("jdbc:mysql://119.23.75.195:3306/car-marketing-server?useUnicode=true&useSSL=false&characterEncoding=utf-8");
...
//        pc.setModuleName("rbac");                             //指定生成的模块名称
        pc.setParent("com.woniu.car.marketing.web");         //设置模块中的父目录名
...
//        strategy.setInclude("t_user","city","county","countrylanguage");
        strategy.setInclude("t_advertising","t_coupon","t_coupon_info");
