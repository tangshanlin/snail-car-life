package com.woniu.car.order.web.config;
...
public class MybatisPlusAutoCode {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath+"/car-commons-server/car-commons-web2/src/main/java");
        gc.setAuthor("WP");                            //设置项目作者
        ...
        dsc.setUrl("jdbc:mysql://119.23.75.195/db_car_order?characterEncoding=utf-8");
        ...
        pc.setParent("com.woniu.car.commons.client1");                            //设置模块中的父目录名
        ...
        // 设置要生成的实体类对应映射的表名
        strategy.setInclude("t_carservice_order","t_carservice_returns","t_order_invoice","t_order_logistics","t_powerplant_order","t_product_order","t_product_order_detail","t_product_order_returns");
